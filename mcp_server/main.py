...
def collections_all(
    ...
    sort: Optional[CollectionsSort] = None,
...
@app.get(
    ...
    tags=['collection_tag_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def collection_tickets_all(
    ...
    limit: Optional[conint(ge=1, le=200)] = 20,
    collection_id: str = ...,
    sort: Optional[TicketsSort] = None,
    filter: Optional[IssuesFilter] = None,
    fields: Optional[str] = None,
):
    """
    List Tickets
...
@app.get(
    ...
    tags=['ticket_comment_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def collection_ticket_comments_all(
    ...
    collection_id: str = ...,
    ticket_id: str = ...,
    sort: Optional[CommentsSort] = None,
    fields: Optional[str] = None,
):
    """
    List Comments
...
@app.post(
    ...
    tags=['ticket_comment_management', 'ticket_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['collection_user_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
